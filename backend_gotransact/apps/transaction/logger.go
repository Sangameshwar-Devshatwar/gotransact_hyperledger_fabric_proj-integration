...
func Init() {
	...
	infoFile, err := os.OpenFile("./apps/transaction/logger/infolog.log", os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0666)
	if err == nil {
	...
	errorFile, err := os.OpenFile("./apps/transaction/logger/error.log", os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0666)
	if err == nil {
